...
private enum Consts {
    static let backgroundImage = UIImage(named: "white_wall")
...
final class CanvasView: UIView {
    ...
    var instrument: InstrumentType = .pencil {
        didSet {
    ...
    private func commonInit() {
        ...
        addSubviews(backgroundImageView, prevFrameRecordView, currentRecordView, drawView)
